from sys import exit #importing the exit module
...
def gold_room():
    ...
    if "0" in choice or "1" in choice:
        ...
        dead("Man, learn to type a number.") #dead is another function defined below
...
def bear_room():
    ...
    while True:
        ...
        if choice == "take honey":
            ...
            dead("The bear gets pissed and chews ur leg off.")
